  ...
  return (
    <Wrapper isNavOpen={isNavOpen}>
        ...
        <div className="row container">
          <div className="col">
            <h1 className="title mt-8">
              {" "}
              {token ? `Hi ${user.userName}, ` : ""}Welcome to QuickDataLoad
            </h1>
            <p className="welcome">
      ...
      {/* <section className="pricing">
        <h1 className="title">Our prices for MTn</h1>
        <div className="prices__container row container">
          <div className="price__box col">
            <h1 className="title price__title">Smart Earners pricing</h1>
          ...
          <div className="price__box col">
            <h1 className="price__title title">Resellers pricing</h1>
            <div className="price__icon">
              <RiCoinsLine />
            </div>
            <div className="prices">
          ...
          <div className="price__box col">
            <h1 className="price__title title">API Users pricing</h1>
            <div className="price__icon">
              <GiCutDiamond />
            </div>
            <div className="prices">
              ...
              <p className="main_data"> 1gb @ ₦252.2</p>
              <button
